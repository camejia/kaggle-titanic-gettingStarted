...
f3d = test_df[(test_df.Sex == 'female') & (test_df.Pclass == 3) & (test_df.Survived == 0)]
f3s = test_df[(test_df.Sex == 'female') & (test_df.Pclass == 3) & (test_df.Survived == 1)]

m2d = test_df[(test_df.Sex == 'male') & (test_df.Pclass == 2) & (test_df.Survived == 0)]
m2s = test_df[(test_df.Sex == 'male') & (test_df.Pclass == 2) & (test_df.Survived == 1)]
...
test_df[(test_df.Sex == 'female') & (test_df.Pclass == 3) & ((test_df.Fare > 20.7) | (test_df.Age > 24.5))] = 0
test_df[(test_df.Sex == 'male') & (test_df.Pclass == 2) & (test_df.Age < 18.5)] = 1
